module.exports = async ({ github, context, core }) => {
    ...
    await github.rest.issues.createComment({
        ...
        body: [
            ...
            "(You can go to [.github/pull_request_template.md](https://github.com/SonoLink/speculare/blob/main/.github/pull_request_template.md) for more information on how this template is built.)",
            "",
